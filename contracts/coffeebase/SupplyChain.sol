...
contract SupplyChain is Ownable {
    ...
    modifier paidEnough(uint _price) {
        require (
            msg.value >= _price,
            "Amount paid is insufficient to cover the price"
        );
        _;
    }
    ...
    function receiveItem(uint _upc) public shipped(_upc) onlyRetailer {
        ...
        items[_upc].ownerID = msg.sender;
        items[_upc].onlyRetailer = msg.sender;
        items[_upc].itemState = State.Received;
        // Emit the appropriate event
        emit Received(_upc);
    }
    ...
    function purchaseItem(uint _upc) public received(_upc) onlyConsumer {
        ...
        itmes[_upc].itemState = State.Purchased;
        // Emit the appropriate event
        emit Purchased(_upc);
    }
